...
class APIS {
  /*static final String baseurl="http://104.131.5.210:7400";
  static final String terms = baseurl+"/api/users/terms";
  static final String register = baseurl+"/api/users/exist";
  static final String register_user = baseurl+"/api/users";
  static final String login = baseurl+"/api/users/login";
  static final String fileupload = baseurl+"/api/users/doc/";
  static final String getuser = baseurl+"/api/users/";
  static final String profiledata = baseurl+"/api/users/";
  static final String download = baseurl+"/api/users/doc/";
  static final String applyloan = baseurl+"/api/loans";
  static final String bankDetails = baseurl+"/api/loans/";
  static final String bankDocuments = baseurl+"/api/loans/doc/";*/
