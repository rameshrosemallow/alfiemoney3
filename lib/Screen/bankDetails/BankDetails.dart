...
class _RegistrationPageState extends BaseState<BankDetails> implements BankDetailsView {
  ...
  Future bankDetails() async {
    ...
    print(token);
    var postUri = Uri.parse(APIS.bankDetails+"${loanId}");
    print(postUri);
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        BankdetailsResponce registerusers_responce = BankdetailsResponce
